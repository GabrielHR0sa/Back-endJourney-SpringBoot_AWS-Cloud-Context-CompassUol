package src.main.java.src.main.java.src.main.java.com.ltp.ltp;//definindo a pasta a qual o arquivo pertence, o arquivo era da main e agora foi movido para a pasta em questão
